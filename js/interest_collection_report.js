$(document).ready(function () {
    ...
    $('#interest_collection_report_btn').click(function () {
        // Get user access for download
        getUserAccess(function (downloadAccess) {
            // Destroy existing DataTable instance
            $('#interest_collection_report_table').DataTable().destroy();
            ...
            $('#interest_collection_report_table').DataTable({
                "order": [
                    [0, "desc"]
                ],
                'processing': true,
                ...
                'serverMethod': 'post',
                'ajax': {
                    'url': 'api/interest_report_files/get_interest_collection_report.php',
                    'data': function (data) {
