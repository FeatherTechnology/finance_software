...
WHERE cs.status > 8 AND u.id ='$user_id' AND lcc.due_type = 'interest' AND us.id ='$user_id' AND li.balance_amount = 0 AND cs.closed_date BETWEEN '$from_date' AND '$to_date'";
