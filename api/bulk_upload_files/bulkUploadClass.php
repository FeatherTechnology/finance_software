...
class bulkUploadClass
{
    ...
    public function fetchAllRowData($Row)
    {
        $dataArray = array(
            ...
            'issue_amount' => isset($Row[57]) ? $Row[57] : "",
            'transaction_id' => isset($Row[58]) ? $Row[58] : "",
            'cheque_no' => isset($Row[59]) ? $Row[59] : "",
            'issue_date' => isset($Row[60]) ? $Row[60] : "",
            'issue_person' => isset($Row[61]) ? $Row[61] : "",
            'relationship' => isset($Row[62]) ? $Row[62] : "",
        );
