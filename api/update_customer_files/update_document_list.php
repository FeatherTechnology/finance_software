...
$qry = $pdo->query("SELECT lelc.id, lelc.loan_id, lc.loan_category, lelc.loan_date,lelc.loan_amount,lelc.maturity_date,cs.status as c_sts,cs.sub_status as substatus FROM loan_entry_loan_calculation lelc 
LEFT JOIN loan_category_creation lcc ON lelc.loan_category = lcc.id 
LEFT JOIN loan_category lc ON lcc.loan_category = lc.id 
LEFT JOIN customer_status cs ON lelc.id = cs.cus_profile_id 
