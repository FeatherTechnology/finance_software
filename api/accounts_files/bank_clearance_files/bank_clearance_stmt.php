    ...
    <tbody>
        ...
        while($row = $qry->fetch()){ ?>
            <tr>
                ...
                <!-- <td><?php #if($row['credit'] != ''){ echo runcreditCategories($pdo,$admin_access,$bank_id); }elseif($row['debit'] !=''){echo rundebitCategories($pdo,$admin_access,$bank_id); } ?></td> -->
                <td></td>
...
function runcreditCategories($pdo,$admin_access,$bank_id){
...
function rundebitCategories($pdo,$admin_access,$bank_id){
