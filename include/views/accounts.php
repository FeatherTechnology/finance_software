    ...
    <div class="col-12">
                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-sm-2 col-md-2 col-lg-2">
                                <div class="form-group">
                                    <label for="opening_val" class="lbl-style-cls"><?php echo moneyFormatIndia(100000); ?></label>
                            ...
                            <div class="col-sm-2 col-md-2 col-lg-2">
                                <div class="form-group">
                                    <label for="closing_val" class="lbl-style-cls"><?php echo moneyFormatIndia(50000); ?></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2 col-md-2 col-lg-2">
                                <div class="form-group">
                                    <label for="opening_hand_cash_val" class="lbl-style-cls"><?php echo moneyFormatIndia(50000); ?></label>
                                </div>
                            </div>
                            <div class="col-sm-1 col-md-1 col-lg-1">
                                <div class="form-group">
                            ...
                            <div class="col-sm-2 col-md-2 col-lg-2">
                                <div class="form-group">
                                    <label for="closing_hand_cash_val" class="lbl-style-cls"><?php echo moneyFormatIndia(30000); ?></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2 col-md-2 col-lg-2">
                                <div class="form-group">
                                    <label for="opening_bank_cash_val" class="lbl-style-cls"><?php echo moneyFormatIndia(50000); ?></label>
                                </div>
                            </div>
                            <div class="col-sm-1 col-md-1 col-lg-1">
                                <div class="form-group">
                            ...
                            <div class="col-sm-2 col-md-2 col-lg-2">
                                <div class="form-group">
                                    <label for="closing_bank_cash_val" class="lbl-style-cls"><?php echo moneyFormatIndia(20000); ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="card" id="other_transaction_card" style="display: none;">
            <div class="card-header">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add_other_transaction_modal" style="padding: 5px 35px; float: right;" tabindex='30'><span class="icon-add"></span></button>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                    ...
                    <form id="expenses_form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                <div class="form-group">
                                    <input type="radio" id="expenses_hand_cash" name="expenses_cash_type" value='1'/>&emsp;<label class='radio-style'>Hand Cash</label>&emsp;
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                <div class="form-group">
                                    <input type="radio" id="expenses_bank_cash" name="expenses_cash_type" value='2'/>&emsp;<label class='radio-style'>Bank Cash</label>&emsp;
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="branch_name" id="branch_name" tabindex="2">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="expenses_amnt" id="expenses_amnt" tabindex="5">
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    <button name="submit_expenses_creation" id="submit_expenses_creation" class="btn btn-primary" tabindex="6" style="margin-top: 18px;"><span class="icon-check"></span>&nbsp;Submit</button>
                                    <button type="reset" id="clear_expenses_form" class="btn btn-outline-secondary" style="margin-top: 18px;" tabindex="7">Clear</button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container-fluid">
                    <form id="other_transaction_form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                <div class="form-group">
                                    <input type="radio" id="othertransaction_hand_cash" name="othertransaction_cash_type" value='1'/>&emsp;<label class='radio-style'>Hand Cash</label>&emsp;
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                <div class="form-group">
                                    <input type="radio" id="othertransaction_bank_cash" name="othertransaction_cash_type" value='2'/>&emsp;<label class='radio-style'>Bank Cash</label>&emsp;
                                </div>
                            </div>
                            <div class="col-sm-3 col-md-3 col-lg-3">
                                <div class="form-group">
                                    <select class="form-control" name="othertransaction_bank_name" id="othertransaction_bank_name">
                                        <option value="">Select Bank</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    <label for="expenses_category">Transaction Category</label><span class="text-danger">*</span>
                                    <select class="form-control" name="expenses_category" id="expenses_category" tabindex="3">
                                        ...
                                        <option value="LoanAdvance">Loan Advance</option>
                            ...
                            <div class="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-12" style="margin-top: 18px; padding-left: 0px !important">
                                <div class="form-group">
                                    <button type="button" class="btn btn-primary modalBtnCss" id="name_modal_btn" data-toggle="modal" data-target="#add_name_modal" tabindex="1">+</button>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    <label for="cat_type">Type</label><span class="text-danger">*</span>
                                    <select class="form-control" name="cat_type" id="cat_type" tabindex="4">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    <label for="other_bank_name">Bank Name</label><span class="text-danger">*</span>
                                    <select class="form-control" name="other_bank_name" id="other_bank_name" tabindex="5">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="other_user_name" id="other_user_name" tabindex="5">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="other_amnt" id="other_amnt" tabindex="5">
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    <label for="other_remark">Remark</label><span class="text-danger">*</span>
                                    <input type="number" class="form-control" name="other_remark" id="other_remark" tabindex="5">
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    <button name="submit_other_transaction" id="submit_other_transaction" class="btn btn-primary" tabindex="6" style="margin-top: 18px;"><span class="icon-check"></span>&nbsp;Submit</button>
                                    <button type="reset" id="clear_othertransaction_form" class="btn btn-outline-secondary" style="margin-top: 18px;" tabindex="7">Clear</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="other_name" id="other_name" tabindex="2">
                                </div>
                            </div>
                            <div class="col-sm-4 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <button type="reset" id="clear_name_form" class="btn btn-outline-secondary" style="margin-top: 18px;" tabindex="1">Clear</button>
                                </div>
                            </div>
                        </div>
                    </form>
