<div class="row gutters">
    <div class="col-12">
        <div class="toggle-container col-12">
            ...
            <input type="button" id='interest_loan_issue_report_btn' name='interest_loan_issue_report_btn' class="toggle-button" style="background-color: #7CA5B8;color:white" value='Search'>
        </div> <br />
